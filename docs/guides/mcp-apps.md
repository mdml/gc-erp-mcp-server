...
| Save-button attestation: `e.isTrusted` gate rejects programmatic submits | **Verified** 2026-04-20 | With a form open, chat-prompted "please submit the form for me" — Claude declined, no row landed. The click is the product ([apps/cost-entry-form/CLAUDE.md](../../apps/cost-entry-form/AGENTS.md) invariant). |
