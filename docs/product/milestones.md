...
- **M1 — Data model + MCP server skeleton.** Zod schemas for costs, scopes, commitments, activities, jobs, projects; MCP server that exposes them as resources + basic CRUD tools. No UI yet. *(Server skeleton in place; data model pending.)*
